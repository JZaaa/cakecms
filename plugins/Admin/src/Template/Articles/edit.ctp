...
<?php $this->end()?>
    <div class="zad-content">
        <form action="<?php echo $this->Url->build(['plugin' => 'Admin', 'controller' => 'Articles', 'action' => 'edit', $id, '?' => ['type' => $type]])?>" method="post" data-toggle="ajaxform" autocomplete="off">
            ...
            <div class="tab-content">
                <div class="tab-pane fade active in" id="baseContent">
                    <div class="with-padding">
                        <?php if (!in_array($data->site_menu->type, [1])):?>
                        <div class="form-group">
                            ...
                            <select id="site_menu_id" name="site_menu_id" class="chosen-select form-control" data-toggle="selectpicker">
                                <?php foreach ($siteMenus as $key => $item):?>
                                    <option value="<?php echo $key?>" <?php if ($data->site_menu_id == $key) echo 'selected'?>><?php echo $item?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
                        <?php endif;?>
                            ...
                            <div class="col-xs-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="color" name="color" data-provide="colorpicker" data-wrapper="input-group-btn" data-pull-menu-right="true" value="<?php echo $data->color?>" placeholder="请输入16进制颜色值，例如 #FF00DD">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-3">
                                <div class="form-group">
                                    ...
                                    <input id="date" name="date" value="<?php echo $data->date?>" type="text" class="form-control" data-toggle="datepicker" data-type="datetime">
                                </div>
                            </div>
                            <div class="col-xs-3">
                                <div class="form-group">
                                    <label for="source">来源</label>
                                    <input id="source" name="source" value="<?php echo $data->source?>" type="text" class="form-control">
                                </div>
                            </div>
                            <div class="col-xs-3">
                                <div class="form-group">
                                    <label for="author">作者</label>
                                    <input id="author" name="author" value="<?php echo $data->author?>" type="text" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-4">
                                <div class="form-group">
                                    ...
                                    <select id="istop" name="istop" class="chosen-select form-control" data-toggle="selectpicker">
                                        <option value="2" <?php if ($data->istop == 2) echo 'selected'?>>否</option>
                                        <option value="1" <?php if ($data->istop == 1) echo 'selected'?>>是</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                    ...
                                    <select id="status" name="status" class="chosen-select form-control" data-toggle="selectpicker">
                                        <option value="1" <?php if ($data->status == 1) echo 'selected'?>>发布</option>
                                        <option value="2" <?php if ($data->status == 2) echo 'selected'?>>草稿</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                    ...
                                    <input id="visit" name="visit" value="<?php echo $data->visit?>" type="text" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="content">内容</label>
                            <textarea id="content" data-toggle="kindeditor" name="content" class="form-control"><?php echo $data->content?></textarea>
                        </div>
                    </div>
                </div>
                <div class="tab-pane fade" id="otherContent">
                    <div class="with-padding">
                        ...
                        <div class="form-group">
                            ...
                            <input id="seo_keywords" name="seo_keywords" value="<?php echo $data->seo_keywords?>" type="text" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="seo_description">SEO描述</label>
                            <textarea id="seo_description" name="seo_description" class="form-control"><?php echo $data->seo_description?></textarea>
                        </div>
                    </div>
                </div>
            </div>
